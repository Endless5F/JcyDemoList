...
public class ThreadPoolUtils {
    ...
    // 线程池核心线程数
    private final int CORE_POOL_SIZE = 5;// 3
    // 线程池最大线程数
    private final int MAX_POOL_SIZE = 50;// 50
    // 额外线程空状态生存时间
    private final int KEEP_ALIVE_TIME = 50;// 50
    ...
    private class MyThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(Runnable r) {
            Thread ret = new Thread(group, r, "MyThread"
                    + r.getClass().getName(), 0);
            return ret;
        }
