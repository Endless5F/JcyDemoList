...
public class SuperHandler extends Handler {
    ...
    public boolean sendMessageAtTime(Message msg, long uptimeMillis) {
        ...
        if (send) {
            GetDetailHandlerHelper.getMsgDetail().put(msg,
                    Log.getStackTraceString(new Throwable()).replace("java.lang.Throwable", ""));
        }
        return send;
    }
    ...
    public void dispatchMessage(Message msg) {
        ...
        if (GetDetailHandlerHelper.getMsgDetail().containsKey(msg)
            ...
            try {
                ...
                jsonObject.put("MsgTrace",
                        msg.getTarget() + " " + GetDetailHandlerHelper.getMsgDetail().get(msg));
