...
import static com.android.customwidget.kotlin.widget.ThouchLinearLayout.SCROLL_STATE_DRAGGING;
import static com.android.customwidget.kotlin.widget.ThouchLinearLayout.SCROLL_STATE_IDLE;
import static com.android.customwidget.kotlin.widget.ThouchLinearLayout.SCROLL_STATE_SETTLING;
...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
        ...
        if (mDispatchSelected) {
            ...
            mDispatchSelected = false;
            boolean scrollingForward = dy > 0 || (dy == 0 && dx < 0 == false/*mViewPager.isRtl()*/);
