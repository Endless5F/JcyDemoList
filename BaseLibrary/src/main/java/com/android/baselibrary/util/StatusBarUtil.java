...
public class StatusBarUtil {
    ...
    private static final int DEFAULT_STATUS_BAR_ALPHA = 38;//default 112
    ...
    public static void setDrawable(Activity activity, @DrawableRes int drawableId) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (fakeStatusBarView != null) {
                ...
                fakeStatusBarView.setBackgroundResource(drawableId);
            } else {
                decorView.addView(createStatusBarDrawableView(activity, drawableId));
            }
     ...
     *
     * @param activity 需要设置的activity
     * @param drawableId    背景布局
     * @return 状态栏矩形条
     */
    private static View createStatusBarDrawableView(Activity activity, @DrawableRes int drawableId) {
        // 绘制一个和状态栏一样高的矩形
