package com.android.performanceanalysis.webview.utils;
    ...
    public static void copy(String content) {
        if (!TextUtils.isEmpty(content)) {
            if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.HONEYCOMB) {
                ClipboardManager clipboard = (ClipboardManager) LaunchApplication.getInstance().getSystemService(Context.CLIPBOARD_SERVICE);
